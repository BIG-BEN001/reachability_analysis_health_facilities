...
L.Control.Reachability = L.Control.extend({
    options: {
        ...
        // API settings
        apiKey: '5b3ce3597851110001cf6248279b92fbae9e4a26912535a4df2861cd',                                     // openrouteservice API key - the service which returns the isoline polygons based on the various options/parameters
